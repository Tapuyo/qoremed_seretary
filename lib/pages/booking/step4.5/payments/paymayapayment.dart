...
class PaymayaPayment extends StatefulWidget {
  @override
  _PaymayaPaymentState createState() => _PaymayaPaymentState();
}

class _PaymayaPaymentState extends State<PaymayaPayment> {
  Future<File> file;
  String status = '';
  String base64Image;
  File tmpFile;
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("1st - Please pay your fee (Php " + AppVar.doccharge + ") at Paymaya account listed below."),
