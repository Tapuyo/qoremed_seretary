...
class AppTodayS extends StatefulWidget {
  String stat,questat;
  AppTodayS(this.stat,this.questat);
  @override
  _TimeSlotPageState createState() => _TimeSlotPageState(this.stat,this.questat);
}

class _TimeSlotPageState extends State<AppTodayS> {
  String stat,questat;
  ...
  void sendAndRetrieveMessage(String toks, stat) async {
  ...
  Future<List<Appointunpaid>> getfinishunpaid() async{
    ...
    for (var u in jsondata){
      ...
      if(u['end_time'] == "Unpaid" && u['status'] == "completed") {

        Appointunpaid apps = Appointunpaid(
            appid,
            docname,
            appdate,
            docimg,
  ...
  Future<List<Appointunpaid>> getfinishpaid() async{
    Map<String, String> headers = {"Content-type": "application/json", "Accept": "application/json", 'Authorization': 'Bearer ' + AppVar.token};
    String url = "https://qoremed.qoreit.com/api/appointments?period_id=" + AppVar.periodid;
    final response = await http.get(url,headers: headers);
  ...
  Future<List<Appoint>> getSched() async{
    ...
    for (var u in jsondata){
      ...
      if(status != "cancelled" && status != "completed" && status != "queued" && status != "serving" && status != "unpaid" && status != "paid") {
        Appoint apps = Appoint(
            appid,
            docname,
            appdate,
  ...
  markaspaid(String appid,stat)async{
  ...
  getfcmuser(String uid,stat)async{
    ...
    if(response.statusCode == 200){
      sendAndRetrieveMessage(jsonDecode(response.body)['user']['fcm_token'],stat);
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text("Start Queue",style: TextStyle(color: _goodna1 ? Colors.green:Colors.black54),)
                  ],
                ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('On-Site Consultation',style: TextStyle(fontSize: 20),),
                  ],
                ),
                                  ...
                                  secondaryActions: <Widget>[
                                    ...
                                    /*    IconSlideAction(
                                        ...
                                        onTap: (){
                                          ...
                                          setState(() {
                                            updatestat(snapshot.data[index].appid, "confirm",snapshot.data[index].uid);
                                          });

                                        }
                                    ),*/
                                    Visibility(
                                      visible: snapshot.data[index].pym,
                                      child: IconSlideAction(
                                          ...
                                          onTap: (){
                                            ...
                                            markaspaid(snapshot.data[index].appid,'paid');
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  //asd
                                                  Text(
                                                    'Consultation: ' + snapshot.data[index].consult,
                                                    style: TextStyle(
                                                      fontSize: 12,
                                                      fontFamily: 'NunitoSans',
                                                      fontWeight: FontWeight.w300,
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            mystatque(snapshot.data[index].appid,snapshot.data[index].status,snapshot.data[index].uid),
  ...
  mystatque(String appid,stat,uid){
...
class Appointpaid{
  ...
  Appointpaid(this.appid, this.docname, this.appdate,this.docimg,this.special,this.hospital,this.name,this.status,this.consult,this.ref,
...
class Appointunpaid{
  ...
  Appointunpaid(this.appid, this.docname, this.appdate,this.docimg,this.special,this.hospital,this.name,this.status,this.consult,this.ref,
      this.starttime,this.endtime,this.que, this.meet,this.payment,this.uid);
}