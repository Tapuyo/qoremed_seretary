...
import 'package:qoremed_app/pages/profile/patient/bookdetails.dart';
import 'package:qoremed_app/utils/constants.dart';
import 'dart:convert';


class PatientBook extends StatefulWidget {

  @override
  _TimeSlotPageState createState() => _TimeSlotPageState();
}

class _TimeSlotPageState extends State<PatientBook> {
  ...
  getfcmuser(String stat,uid)async{
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Book Appointments',style: TextStyle(fontSize: 16),),
                SizedBox(height: 2,),
                              ...
                              return Container(
                                ...
                                child: Slidable(
                                  ...
                                  secondaryActions: <Widget>[
                                    ...
                                    IconSlideAction(
                                        ...
                                        onTap: (){
                                          ...
                                          setState(() {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(builder: (context) => BookDetails(snapshot.data[index].appid),
                                              ),
                                            );
                                          });
                                    ...
                                    IconSlideAction(
                                        caption: snapshot.data[index].payment,
                                        color: Colors.white,
                                        icon: Icons.payment,
                                        onTap: (){

                                          setState(() {
                                            updatestat(snapshot.data[index].appid, "paid",snapshot.data[index].uid);
                                          });
